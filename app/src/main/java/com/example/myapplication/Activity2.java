...
public class Activity2 extends AppCompatActivity {
    ...
    public void MediaPlayer(View view) {
        if (player == null) {
            player = MediaPlayer.create(this, R.raw.yooooooooooo);
        }
        player.start();
    }
    public void Json(){
        try {
            ...
            int aJsonInteger = jObject.getInt(Integer.parseInt("INTEGERNAME"));
            String aJsonString = jObject.getString(Integer.parseInt("STRINGNAME"));
